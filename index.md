...
Click on "Change your password"(It should be in blue).
After that put your user and PID again then click submit.
...
After you are in, try out some commands, it should look like this: <img width="1035" alt="Screenshot 2023-01-27 at 6 17 31 PM" src="https://user-images.githubusercontent.com/122418243/215237061-2afed92e-f63d-4e64-8e8b-3cdc3b7650c2.png">
The command "cd ~" lets you change your directory or allowes you to move between directories/path. The command "cd" works similar to cd ~, cd allows you to switch the current working directory to the given path. The command "ls -lat" gives you the list of all the files in your current directory. It also gives the files name, date and other information. The command "ls -a" shows you the hidden files that are in the current directory. This command will only show you the files name. 
Now your done!!
(To exit out of the server all you have to do is press control + D on ur keyboard.)
